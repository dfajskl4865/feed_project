          ...
          <div className="feed-con">
            <div className="row">
              <div className="imgbox cell">
                <img src={props.catdry[id].img} width="50%" />
              </div>
              <div className="imgbox cell">
                <p className="detail-title">{props.catdry[id].title}</p>
                <p className="detail-price">{props.catdry[id].price}</p>
                <button
                  className="buy-btn"
                  onClick={() => {
                    window.location.href = props.catdry[id].site;
                  }}
                >
                  주문하기
                </button>
